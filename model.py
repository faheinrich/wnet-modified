...
class WNet(nn.Module):
    def __init__(self):
        ...
        self.U_encoder = BaseNet(input_channels=config.inputChannels, encoder=config.encoderLayerSizes,
        ...
        self.U_decoder = BaseNet(input_channels=config.k, encoder=config.encoderLayerSizes,
                                    decoder=config.decoderLayerSizes, output_channels=config.inputChannels)
